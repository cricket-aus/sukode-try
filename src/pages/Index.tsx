...
const completionExample = `// Start typing and let Sukode complete your code
function calculateTotalPrice(items) {
  // Sukode suggests the following:
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="z-10">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Code Faster with{" "}
              <span className="text-gradient-cerebras">AI-Powered</span>{" "}
              Intelligence
            </h1>
            <p className="text-white/70 text-lg mb-8 max-w-lg">
              Supercharge your development workflow with the smartest AI coding
              assistant for VS Code, powered by Cerebras state-of-the-art
            ...
            <div className="mt-8 text-white/50 text-sm">
              Compatible with all VS Code versions. No account required to
              start.
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 max-w-2xl mx-auto">
              Enhance your coding experience with intelligent features powered
              by Cerebras' cutting-edge AI technology.
            </p>
          </div>
      ...
      <section id="how-it-works" className="py-20 px-6 md:px-10 bg-black/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 max-w-2xl mx-auto">
              Sukode seamlessly integrates with your VS Code environment to
              ...
              <div className="space-y-10">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">
                      Install Sukode from the VS Code marketplace and activate
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">
                      Start typing your code as usual. Sukode observes your
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">
                      Get intelligent code suggestions that match your coding
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">
                      Accept suggestions with a tab key or continue typing to
      ...
      <section id="testimonials" className="py-20 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 max-w-2xl mx-auto">
              See what developers are saying about their experience with Sukode.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <TestimonialCard
              quote="Sukode has completely transformed my development workflow. The suggestions are spot-on and the performance is incredible."
              author="Sarah Johnson"
              role="Senior Frontend Developer"
              stars={5}
            />
            <TestimonialCard
              quote="I've tried many AI coding assistants, but nothing comes close to the speed and accuracy of Sukode with Cerebras tech."
              author="Michael Chen"
            ...
            />
            <TestimonialCard
              quote="Sukode understands my coding style better than any other tool I've used. It feels like having a senior dev pair programming with me."
      ...
      <section id="pricing" className="py-20 px-6 md:px-10 bg-black/20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 text-center">
            ...
            <a
              href="#"
              className="text-cerebras-300 hover:text-cerebras-200 underline"
            >
      ...
      <section className="py-20 px-6 md:px-10">
        <div className="max-w-4xl mx-auto text-center glass-morphism rounded-2xl p-12">
          ...
          <p className="text-white/70 mb-8 max-w-2xl mx-auto">
            ...
            productivity with Sukode powered by Cerebras.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              variant="outline"
              className="bg-transparent border-white/20 hover:bg-white/5 text-white px-8 py-6 text-lg"
            >
              View Documentation
            </Button>
          </div>
